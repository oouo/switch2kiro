...
object WindowUtils {
    ...
    fun activeWindow() {
        ...
        try {
            val command = """Get-Process | Where-Object { ${'$'}_.ProcessName -eq 'Kiro' -and ${'$'}_.MainWindowTitle -match 'Kiro' } | Sort-Object { ${'$'}_.StartTime } -Descending | Select-Object -First 1 | ForEach-Object { (New-Object -ComObject WScript.Shell).AppActivate(${'$'}_.Id) }"""
            ...
            logger.error("Failed to activate Kiro window", e)
        }
    }
}
